...
impl LineBatch {
    pub fn init(capacity: usize) -> Self {
        ...
        Self { capacity, index, buffer, mesh, }
    }


    pub fn line(&mut self, x1: f32, y1: f32, z1: f32, x2: f32, y2: f32, z2: f32, r: f32, g: f32, b: f32, a: f32) {
    ...
    pub fn boxx(&mut self, x: f32, y: f32, z: f32, w: f32, h: f32, d: f32, r: f32, g: f32, b: f32, a: f32) {
        let w_half = w * 0.5;
        let h_half = h * 0.5;
        let d_half = d * 0.5;
